...
int main() {
    ...
    do {
        ...
        printf("===========================================\n");
        printf("=             Dificuldade                 =\n");
        printf("=      Aperte '1' para fácil              =\n");
        printf("=      Aperte '2' para médio              =\n");
        printf("=      Aperte '3' para difícil            =\n");
        printf("===========================================\n");
        printf("Level: ");
        scanf("%d", &level);
        system("cls");
        ...
        switch (level) {
            case 1: {
                ...
                do {
                    ...
                    if (!acertou) {
                        erros++; 
                        printf("Letra errada, número de tentativas restantes: %d\n\n", 4 - erros);
                    }
            ...
            default:
                printf("Escolha de nível inválida.\n");
                break;
        }
